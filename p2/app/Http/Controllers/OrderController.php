...
{
    /**
    *Get the welcome page's order.
    **/
    public function order(Request $request)
    {
        // Will only validate the following areas of the form.
        $request->validate([
            'name' => 'required',
            'email' => 'email:rfc,dns',
            'sandwich' => 'required',
        ...
        // Gets the user's input for the following areas of the form.
        ...
        // All data in the form is redirected to the '/' page after being inputted.
